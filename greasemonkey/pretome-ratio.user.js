...
/**
 * Creates the span element which contains the ratio.
 */
...
function ratio_user_infobox() {
    ...
    if (snapTotalData) {
        ...
        var textPattern = /(?:total:|stats\/\/ total) ([0-9.]+) ([GT]B)[ ]*(?:\(|[.]+)([0-9.]+) ([GT]B) up\)?/i
            ...
            switch (element.nodeName) {
                ...
                case "LI":
                    ...
                    // Most other themes.
                case "TD":
                    // Create a new row in the User Info table.
        ...
        unsafeWindow.console.error("Could not find the user stats element.");
    }
}
ratio_user_infobox();
